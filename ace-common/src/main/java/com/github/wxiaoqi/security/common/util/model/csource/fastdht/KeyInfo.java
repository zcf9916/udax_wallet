...
import com.github.wxiaoqi.security.common.util.model.csource.common.Hash;
...
public class KeyInfo {
    ...
    public KeyInfo(byte[] namespace, byte[] object_id, byte[] key) throws UnsupportedEncodingException,Exception {
    ...
    public KeyInfo(String namespace, String object_id, String key) throws UnsupportedEncodingException, Exception {
    ...
    private void check() throws Exception {
        ...
        if ((namespace_len == 0 && obj_id_len != 0) || (namespace_len != 0 && obj_id_len == 0)) {
            throw new Exception("Invalid namespace length: " + this.namespace.length + " and object ID length: "
