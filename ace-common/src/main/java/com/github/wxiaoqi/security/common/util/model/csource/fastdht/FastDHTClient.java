...
package com.github.wxiaoqi.security.common.util.model.csource.fastdht;
...
public class FastDHTClient {
     ...
     */
    public int set(KeyInfo keyInfo, String value) throws UnsupportedEncodingException, Exception {
     ...
     * @return 0 for success, != 0(errno) for fail
     */
    public int set(KeyInfo keyInfo, byte[] value) throws UnsupportedEncodingException, Exception {
     ...
     * @return 0 for success, != 0(errno) for fail
     */
    public int set(KeyInfo keyInfo, String value, int expires) throws UnsupportedEncodingException, Exception {
     ...
     * @return 0 for success, != 0(errno) for fail
     */
    public int set(KeyInfo keyInfo, byte[] value, int expires) throws UnsupportedEncodingException, Exception {
        ServerInfo server;
     ...
     */
    public String get(KeyInfo keyInfo) throws UnsupportedEncodingException, Exception {
     ...
     * @return none null for success, null for fail
     */
    public String get(KeyInfo keyInfo, int expires) throws UnsupportedEncodingException, Exception {
        byte[] bs;
     ...
     * @return none null for success, null for fail
     */
    public byte[] getBytes(KeyInfo keyInfo) throws UnsupportedEncodingException, Exception {
     ...
     */
    @SuppressWarnings("unused")
    public String[] getSubKeys(ObjectInfo objInfo) throws UnsupportedEncodingException, Exception {
        ServerInfo server;
        ProtoCommon.PkgHeader header;
        byte[] bsPackage;
        byte status;
