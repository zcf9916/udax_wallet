...
public class BaseContextHandler {
	...
	public static Long getExId() {
		Object value = get(CommonConstants.CONTEXT_KEY_EX_ID);
		String exId = returnObjectValue(value);
		if (exId != null) {
			return Long.parseLong(exId);
		}
		return null;
	}

	public static Long getAppExId() {
		Object value = get(CommonConstants.CONTEXT_APP_KEY_EX_ID);
		String exId = returnObjectValue(value);
		if (exId != null) {
			return Long.parseLong(exId);
		}
	...
	public static String getLanguage() {
		Object value = get(CommonConstants.CONTEXT_APP_KEY_LAN);
		String returnValue =   returnObjectValue(value);
		return StringUtils.isBlank(returnValue) ? "en" : returnValue;
	}

	public static void setLanguage(String language) {
		if(StringUtils.isBlank(language)){
			set(CommonConstants.CONTEXT_APP_KEY_LAN, "en");
			return;
		}
		set(CommonConstants.CONTEXT_APP_KEY_LAN, language);
	}
	...
	public static void setExId(Long exId) {
		set(CommonConstants.CONTEXT_KEY_EX_ID, exId);
	}

	public static void setAppExId(Long exId) {
		set(CommonConstants.CONTEXT_APP_KEY_EX_ID, exId);
	}
...
//			BaseContextHandler.setUserID(1L);
