...
import com.github.wxiaoqi.security.common.support.security.BASE64Encoder;
import com.github.wxiaoqi.security.common.support.security.coder.DESCoder;
import com.github.wxiaoqi.security.common.support.security.coder.HmacCoder;
import com.github.wxiaoqi.security.common.support.security.coder.MDCoder;
import com.github.wxiaoqi.security.common.support.security.coder.RSACoder;
import com.github.wxiaoqi.security.common.support.security.coder.SHACoder;
...
public final class SecurityUtil {
	...
	public static final String encryptSHA1(String data) {
		try {
			return encryptBASE64(SHACoder.encodeSHA1(data.getBytes(CHARSET)));
		} catch (Exception e) {
			throw new RuntimeException("加密错误，错误信息：", e);
		}
	}
	...
	public static void main(String[] args) throws Exception {
		System.out.println(encryptDes("udax@mysql123#$","90139119".getBytes()));
//		System.out.println(decryptDes("2JwIcthbo340K0xjQubxda=="));
