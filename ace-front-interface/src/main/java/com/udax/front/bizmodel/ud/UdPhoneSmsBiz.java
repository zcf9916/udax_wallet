 ...
 */
@Service
public class UdPhoneSmsBiz extends UdSendSmsBiz {

	public UdPhoneSmsBiz() {
		super();
	}

	public ObjectRestResponse sendValidCode(SmsModel model, HUserInfoBiz biz, Long exchId) {
