 ...
 * 发送邮件验证码相关业务逻辑
 */
public class UdEmailSmsBiz extends UdSendSmsBiz {
	protected final Logger logger = LogManager.getLogger(this.getClass());

	public UdEmailSmsBiz() {
		super();
		// TODO Auto-generated constructor stub
	}

	@Override
	public ObjectRestResponse sendValidCode(SmsModel model, HUserInfoBiz userBiz, Long exchId) {
